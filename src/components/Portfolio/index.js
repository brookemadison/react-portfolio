      ...
      <Row className="justify-content-md-center">
        <Col xs lg="7">
          <section>
            <div id="Project">
              <h3>
                A <em>small gallery</em> of recent projects{" "}
                <em>chosen by me.</em> Interested to <em>see some more? </em>{" "}
                Visit my{" "}
                <a
              ...
              <a href="https://github.com/brookemadison">
                <button className="btns see-more-btn">See More</button>
              </a>
            </div>
            <p>
              This is where magic comes to life and visual stories are made. I
              believe that design must solve a need, stir a desire for
              involvement, and shed light on a path that is enjoyable,
        ...
        {Array.from({ length: 1 }).map((_, idx) => (
          <Col>
            ...
            <Card>
              ...
              <Card.Body>
                <Card.Title>
                  <h4>High Tech Love Match</h4>
                </Card.Title>
                <Card.Text>
                  High Tech Love Match is a dating app specifically created with
                  the software engineer in mind. It is built to match
                  like-minded people who are seeking a relationship.
                </Card.Text>
                <Card.Text>Technologies Used:</Card.Text>
                <Card.Text>
                  React / JavaScript / HTML / CSS / Axios / Apollo / GraphQL /
                  Node.js / Express / Express.js / express session / MongoDB /
                  Mongoose ODM / React Router DOM / Bcrypt / Dotenv / JWT
                  /Heroku / Firebase / Cloudinary / Github API / dayjs
                </Card.Text>
        ...
        <Col>
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <Card.Text>
                An online Pokédex that allows users to view and search for their
                favorite original 151 Pokémon.
              </Card.Text>
              <Card.Text>Technologies Used:</Card.Text>
              <Card.Text>
                HTML / CSS / Javascript / Node.js / Express / MySQL / dotenv /
                Heroku / jawsDB /Sequelize / Bcrypt / express-session /
                Handlebars / Animate.css / PokéAPI
              </Card.Text>
        ...
        <Col>
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <Card.Text>
                A date night app crafted to offer a unique experience to users
                by taking a quiz that pairs you with a recipe, cocktail, and
                music playlist recommendation
              </Card.Text>
              <Card.Text>Technologies Used:</Card.Text>
              <Card.Text>
                HTML / CSS / Javascript / jQuery / Bulma / Spoonacular API /
                Spotify API
              </Card.Text>
        ...
        <Col>
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <Card.Text>
                A PWA budget tracker application allows for offline access and
                functionality to to add expenses and deposits to their budget
        ...
        <Col>
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <Card.Text>
                This password generator was developed as a way to generate a
                strong password that provides greater security. Before clicking
                the generate password button you are prompted with settings that
                give you the ability to confirm whether or not to include
        ...
        <Col>
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <Card.Text>
                A social network API that uses a NoSQL database where users can
              ...
              <Card.Text>
                ...
                Insomnia Core / express session / dayjs / dotenv
              </Card.Text>
